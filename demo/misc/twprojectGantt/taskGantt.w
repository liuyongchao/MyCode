...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    style="height:auto;left:537px;top:39px;" onParamsReceive="modelParamsReceive" onunLoad="modelUnLoad"/>  
  <!-- 不支持media, 需要写link -->  
  <link rel="stylesheet" href="./src/ganttPrint.css" type="text/css" media="print"/>  
  <div xid="workSpace" class="x-full" style="padding:0px; overflow-y:auto; overflow-x:hidden;border:1px solid #e5e5e5;position:relative;margin:0 5px"/>  
<!-- 
...
<form id="gimmeBack" style="display:none;" action="../gimmeBack.jsp" method="post" target="_blank"><input type="hidden" name="prj" id="gimBaPrj"/></form>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="importDialog"
    src="$UI/pm/SCH/process/CountPlan/importMppDialog.w" title="导入文件" status="normal"
    width="50%" height="50%" onReceive="importDialogReceive" style="left:507px;top:83px;"/>
 -->  
  <div xid="gantEditorTemplates" style="display:none;"> 
    <script class="__template__" type="GANTBUTTONS"> <![CDATA[
  <div xid="ganttButtonBar" class="ganttButtonBar noprint buttons">
    <div class="buttons">
    ...
    <script class="__template__" type="TASKSEDITHEAD"> <![CDATA[
 ...
 -->  
    <script class="__template__" type="TASKROW"> <![CDATA[
 ...
 -->  
    <script class="__template__" type="TASKEMPTYROW"> <![CDATA[
  <tr class="taskEditRow emptyRow" >
    ...
    <script class="__template__" type="TASKBAR"> <![CDATA[
  <div class="taskBox taskBoxDiv" taskId="(#=obj.id#)" >
    ...
    <script class="__template__" type="CHANGE_STATUS"> <![CDATA[
    ...
    <script class="__template__" type="TASK_EDITOR"> <![CDATA[
  ...
  <table width="100%">
    <tr>
      <td>
        <table cellpadding="5">
          <tr>
            <td><label for="code">code/short name</label><br><input type="text" name="code" xid="code" value="" class="formElements"></td>
           </tr><tr>
            <td><label for="name">任务名称</label><br><input type="text" name="name" xid="name" value=""  size="35" class="formElements"></td>
          </tr>
          <tr></tr>
            <td>
              <label for="description">description</label><br>
              <textarea rows="5" cols="30" xid="description" name="description" class="formElements"></textarea>
            </td>
          </tr>
        </table>
      </td>
      <td valign="top">
        <table cellpadding="5">
          <tr>
          <td colspan="2"><label for="status">颜色</label><br><div xid="status" class="taskStatus" status=""></div></td>
          <tr>
          <td colspan="2"><label for="progress">进度（百分比）</label><br><input type="text" name="progress" xid="progress" value="" size="3" class="formElements"></td>
          </tr>
          <tr>
          <td><label for="start">开始时间</label><br><input type="text" name="start" xid="start"  value="" class="date" size="10" class="formElements"><input type="checkbox" xid="startIsMilestone"> </td>
          <td rowspan="2" class="graph" style="padding-left:50px"><label for="duration">dur.</label><br><input type="text" name="duration" xid="duration" value=""  size="5" class="formElements"></td>
        </tr><tr>
          <td><label for="end">结束时间</label><br><input type="text" name="end" xid="end" value="" class="date"  size="10" class="formElements"><input type="checkbox" xid="endIsMilestone"></td>
        </table>
      </td>
    </tr>
    </table>
  ...
  <h2>assignments</h2>
  <table  cellspacing="1" cellpadding="0" width="100%" xid="assigsTable">
    <tr>
      <th style="width:100px;">name</th>
      <th style="width:70px;">role</th>
      <th style="width:30px;">est.wklg.</th>
      <th style="width:30px;" xid="addAssig"><span class="teamworkIcon" style="cursor: pointer">+</span></th>
    </tr>
  </table>

  <div style="text-align: right; padding-top: 20px"><button xid="saveButton" class="button big">save</button></div>
  </div>
  ]]> </script>  
    <script class="__template__" type="ASSIGNMENT_ROW"> <![CDATA[
  <tr taskId="(#=obj.task.id#)" assigId="(#=obj.assig.id#)" class="assigEditRow" >
    ...
    <script class="__template__" type="RESOURCE_EDITOR"> <![CDATA[
  <div class="resourceEditor" style="padding: 5px;">

    <h2>Project team</h2>
    <table  cellspacing="1" cellpadding="0" width="100%" xid="resourcesTable">
      <tr>
        <th style="width:100px;">name</th>
        <th style="width:30px;" xid="addResource"><span class="teamworkIcon" style="cursor: pointer">+</span></th>
      </tr>
    </table>

    <div style="text-align: right; padding-top: 20px"><button xid="resSaveButton" class="button big">save</button></div>
  </div>
  ]]> </script>  
    <script class="__template__" type="RESOURCE_ROW"> <![CDATA[
