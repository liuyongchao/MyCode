...
resume事件监听</span>
    ...
    <a class="btn btn-default" component="$UI/system/components/justep/button/button" label="停止事件监听" onClick="stopEventListener" style="width:100%;" xid="button11_4" xui:parent="demoContent" xui:update-mode="insert" >
<i xid="i11_4" />
<span xid="span11_4" >
