...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="testWindowContainer" xid="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content1"> 
      ...
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <h5>1. 主页面静态嵌入“子页面1”；“子页面1”静态嵌入“子页面2”；
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="调用子页面1的事件" xid="button2" onClick="button2Click">
   <i xid="i4"></i>
   <span xid="span4">调用子页面1的事件</span></a></h5>  
        <br/>  
