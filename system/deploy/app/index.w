    ...
    <div class="x-panel-bottom" xid="bottom1" height="60" style="padding-top: 4px;"> 
      <nav class="navbar navbar-default" role="navigation"> 
        <div class="navbar-buttons-container"> 
          <span style="display:inline-block;width:80px;"><![CDATA[应用名：]]></span>  
          <input component="$UI/system/components/justep/input/input" class="form-control"
            style="width:240px;display:inline" xid="appName" value="mainActivity" bind-enable="! $model.appEngine.webIDE"/>  
