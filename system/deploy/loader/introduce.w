    ...
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="apploader"
          ...
          <a component="$UI/system/components/justep/button/button" class="btn btn-default button-getURL" xid="getURL" onClick="getURLClick" icon="linear linear-chevronupcircle">
   <i xid="i2" class="linear linear-chevronupcircle"></i>
   <span xid="span2"></span></a></div>
        </div> 
      </div>  
    <div class="x-panel-content" xid="content1" style="padding:15px"><div xid="div1" style="height:5%;"></div><div xid="div2"><p xid="p1" style="text-align:center;"><![CDATA[apploader使用说明]]></p><p xid="p2"></p></div>
