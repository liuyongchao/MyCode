...
define(function(require) {
	...
	var paasConsoleURL = xpaas.getPaasURL();
	console.log(paasConsoleURL);
	var Model = function() {
		this.callParent();
		...
		this.hasDownloadBtn = bind.observable(true);
	...
	Model.prototype.finish = function() {
		...
		if (this.currentCompose.getInnerModel().finish(this)) {
			this.appEngine.getConfig().paasConsoleURL = paasConsoleURL;
	...
	Model.prototype.downloadBtnClick = function(event) {
		...
		config.paasConsoleURL = paasConsoleURL;
