...
<div xid="div8" style="padding-left: 8px;">
  ...
  </div><div xid="div6" style="padding-left: 8px;">
    
    
  <label xid="label4" class="x-label"><![CDATA[]]></label>
  </div><div xid="div7" style="padding: 8px"> 
  ...
  <label xid="tipLabel" class="x-label" style="font-size:x-large;font-weight:bold;display:none"><![CDATA[未生成android或ios App]]></label></div><div xid="div1" style="padding-left: 8px;"><label xid="howInstallLabel" class="x-label" bind-click="howInstallLabelClick" style="cursor:pointer;display:block;"><![CDATA[如何安装？请点这里]]></label>
  <label xid="importentLabel" class="x-label" bind-click="howInstallLabelClick" style="color:#FF8000;"><![CDATA[]]></label></div></div>
