...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" responsive="true" rowActiveClass="active" class="table table-hover table-striped" xid="dataTables" multiSelect="true" filter="$model.filter($row.val('name'))" data="propertyData">
   <columns xid="columns1"><column name="name" xid="column1"></column>
  <column name="dataType" xid="column2"></column></columns></div></div>
